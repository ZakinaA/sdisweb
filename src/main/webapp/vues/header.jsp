<%-- 
    Document   : header
    Created on : 18 mars 2024, 16:31:27
    Author     : zakina
--%>
...
<html>
  <head> 
    ...
    <!-- Choices.js-->
    <link rel="stylesheet" href="../design/vendor/choices.js/public/assets/styles/choices.min.css">
    <!-- Google fonts - Muli-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
    <!-- theme stylesheet-->
    <link rel="stylesheet" href="../design/css/style.default.css" id="theme-stylesheet">
